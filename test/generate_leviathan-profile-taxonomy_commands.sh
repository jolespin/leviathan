...
do
	...
	cmd="/usr/bin/time -v leviathan-profile-taxonomy.py -1 ${r1} -2 ${r2} -n ${id} -d ${index_directory} -p=-1 -o ../../Analysis/leviathan_output/profiling/taxonomy/  2> logs/${job_name}.e > logs/${job_name}.o"
